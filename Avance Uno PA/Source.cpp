...
void Datos_Cargar()
{
    const char* fileName = "C:\\Users\\Ferdi\\OneDrive\\Escritorio\\PIA-PA\\Citas\\Citas.bin"; // Cambia la ruta para sisterma de computo
...
void Datos_Veterinario_Cargar()
{
    const char* fileName = "C:\\Users\\Ferdi\\OneDrive\\Escritorio\\PIA-PA\\Medicos\\Medicos.bin"; // Ruta al archivo binario para Veterinarios (Cambiar para cada sistema)
